    ...
    <>
      ...
      <div>
        <div className="content-holder">
          <Section className=" justify-center px-11 h-screen flex flex-col items-center w-full mx-auto my-auto bg-white align-middle">
            <SplitTypeFramer>
              <h3 className=" prose font-light text-2xl md:text-[2.5rem] self-center leading-[3rem] md:leading-[4rem]">
